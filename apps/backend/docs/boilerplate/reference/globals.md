...
| --- | --- | --- |
| `PrismaService` | [@libs/database](../../../src/libs/database) | All DB access. Extends `PrismaClient`. |
| `RedisService` | [@libs/redis](../../../src/libs/redis) | Cache, pub/sub, ephemeral state. |
| `LoggerService` | [@libs/logger](../../../src/libs/logger) | Leveled, color-coded logging. |
| `MailService` | [@libs/mail](../../../src/libs/mail) | Send emails via configured SMTP. |
| `STORAGE_PROVIDER` (token) | [@libs/storage](../../../src/libs/storage) | Inject as `StorageProvider` interface. |
| `RequestContextService` | [@common/context](../../../src/common/context) | Per-request state (userId, ip) via `nestjs-cls`. |
...
3. Import the module in [src/app.module.ts](../../../src/app.module.ts) under "Infrastructure modules".
...
`PrismaService`, `RedisService`, etc. work fine from anywhere — including the CLI runner ([src/cli/cli.ts](../../../src/cli/cli.ts)) and seed scripts.
