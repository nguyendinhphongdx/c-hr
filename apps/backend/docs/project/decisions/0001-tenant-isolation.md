...
- [docs/boilerplate/architecture.md](../../boilerplate/architecture.md) — layered architecture
- [src/common/context/request-context.service.ts](../../../src/common/context/request-context.service.ts) — nestjs-cls wrapper
