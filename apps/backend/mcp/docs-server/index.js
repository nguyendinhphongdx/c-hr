 ...
 *
 * Exposes the project's docs (CLAUDE.md, AGENTS.md, docs/**) over the Model Context
 * Protocol (stdio transport) so AI agents like Claude Code can discover and read
 * docs on demand instead of loading the whole tree into context.
 *
 * Tools:
