...
> Outline cho UI/UX của C-HR. Source of truth domain (entities, invariants) ở [apps/backend/docs/project/domain.md](../../../backend/docs/project/domain.md). File này tập trung vào **user flow** và **route map** của FE.
