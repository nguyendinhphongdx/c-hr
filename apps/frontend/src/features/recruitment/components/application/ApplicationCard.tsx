...
export function ApplicationCard({
  ...
  return (
    ...
    >
      ...
      {isHired && (
        <div className="mt-2 inline-flex items-center gap-1 rounded bg-emerald-50 px-2 py-0.5 text-[10px] font-medium text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300">
      ...
      {!isHired && onHire && application.stage.kind === "HIRED" && (
        <button
          ...
          className="mt-2 inline-flex items-center gap-1 rounded bg-primary px-2 py-0.5 text-[10px] font-medium text-primary-foreground hover:opacity-90"
        >
