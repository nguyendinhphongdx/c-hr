...
**a.** Add as a provider in [src/cli/cli.module.ts](../../../apps/backend/src/cli/cli.module.ts):
...
**b.** Map the command name in [src/cli/commands/index.ts](../../../apps/backend/src/cli/commands/index.ts):
