...
The script ([scripts/switch-db.js](../../../apps/backend/scripts/switch-db.js)) rewrites the `provider` line in `prisma/schema.prisma`. Migrations are engine-specific, so:
